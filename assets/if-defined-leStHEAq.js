...
let x = class extends HTMLElement {
  ...
  requestUpdate(t, n, i) {
    let r = !0;
    t !== void 0 &&
      (((i = i || this.constructor.getPropertyOptions(t)).hasChanged || Be)(
        this[t],
        n
      )
...
const pt = window,
  K = pt.trustedTypes,
  he = K ? K.createPolicy("lit-html", { createHTML: (e) => e }) : void 0,
  jt = "$lit$",
...
const gn = (e, t) => {
  ...
  for (let l = 0; l < n; l++) {
    ...
    let c,
      ...
      f = -1,
      h = 0;
    for (; h < a.length && ((o.lastIndex = h), (u = o.exec(a)), u !== null); )
      (h = o.lastIndex),
        o === Z
          ? u[1] === "!--"
            ? (o = de)
            ...
            ? (o = fe)
            : u[2] !== void 0
            ? (Re.test(u[2]) && (r = RegExp("</" + u[2], "g")), (o = k))
            : u[3] !== void 0 && (o = k)
          : o === k
          ? u[0] === ">"
            ? ((o = r ?? Z), (f = -1))
    ...
    s +=
      o === Z
        ? a + dn
        : f >= 0
        ? (i.push(c), a.slice(0, f) + jt + a.slice(f) + U + d)
        : a + U + (f === -2 ? (i.push(void 0), l) : d);
  }
  ...
  constructor({ strings: t, _$litType$: n }, i) {
    ...
    for (; (r = F.nextNode()) !== null && a.length < l; ) {
      if (r.nodeType === 1) {
        ...
        if (r.data === Me) a.push({ type: 2, index: s });
        else {
          let f = -1;
  ...
  u(t) {
    ...
    for (; c !== void 0; ) {
      if (l === c.index) {
        let u;
        c.type === 2
          ? (u = new at(o, o.nextSibling, this, t))
          : c.type === 1
          ? (u = new c.ctor(o, c.name, c.strings, this, t))
          : c.type === 6 && (u = new vn(o, this, t)),
          this._$AV.push(u),
          (c = r[++a]);
      }
    ...
    const { values: i, _$litType$: r } = t,
      s =
        typeof r == "number"
          ? this._$AC(t)
          : (r.el === void 0 &&
              (r.el = rt.createElement(Ue(r.h, r.h[0]), this.options)),
            r);
...
class An extends wt {
  ...
  j(t) {
    t && t !== b
      ? this.element.setAttribute(this.name, yn)
      : this.element.removeAttribute(this.name);
  }
}
class En extends wt {
...
(ft.finalized = !0),
  ...
  (Nt = globalThis.litElementHydrateSupport) === null ||
    Nt === void 0 ||
    Nt.call(globalThis, { LitElement: ft });
const Ae = globalThis.litElementPolyfillSupport;
Ae == null || Ae({ LitElement: ft });
...
function Dn(e, t, n, i, r) {
  let s,
    o,
    l = 0;
  do (o = t + (n - t) / 2), (s = He(o, i, r) - e), s > 0 ? (n = o) : (t = o);
    ...
    (this.tick = (f) => {
      ...
      t(p),
        ...
        (this.playState === "finished" || d >= this.totalDuration + o)
          ? ((this.playState = "finished"),
            (h = this.resolve) === null || h === void 0 || h.call(this, p))
          : this.playState !== "idle" &&
...
function ii(e, t, n, i = {}, r) {
  ...
  const g = Yt(t),
    ...
    w = st.get(g);
  return (
    je(v.animation, !(Kt(h) && v.generator) && i.record !== !1),
    () => {
      const S = () => {
        var _, M;
        return (M =
      ...
      if (
        (Jt(g) && (V.cssRegisterProperty() ? Gn(g) : (p = !1)),
        ...
        (l = e.animate(
          { [g]: $, offset: y, easing: j(h) ? h.map((N) => Ce(N, a)) : void 0 },
          _
        )),
          l.finished ||
            (l.finished = new Promise((N, R) => {
        ...
        ($ = $.map((_) => (typeof _ == "string" ? parseFloat(_) : _))),
          ...
          (l = new r(
            ...
            $,
            Object.assign(Object.assign({}, i), { duration: a, easing: h })
          ));
      else {
        const _ = $[$.length - 1];
      ...
      return (
        o &&
          s(
            ...
            t,
            $,
            { duration: a, delay: c, easing: h, repeat: f, offset: y },
            "motion-one"
          ),
        v.setAnimation(l),
        l
...
const oi = (e) => e(),
  Ke = (e, t, n = P.duration) =>
    new Proxy(
      { animations: e.map(oi).filter(Boolean), duration: n, options: t },
      li
    ),
  ai = (e) => e.animations[0],
  li = {
    get: (e, t) => {
      ...
      switch (t) {
        ...
        case "finished":
          return (
            e.finished ||
              (e.finished = Promise.all(e.animations.map(ci)).catch(Oe)),
            e.finished
          );
        case "stop":
          return () => {
...
(function (e) {
  const t = T,
    ...
    l = t.getBCHDigit(o);
  function a(h, d, A) {
    for (let y = 1; y <= 40; y++) if (d <= e.getCapacity(y, A, h)) return y;
  }
  function c(h, d) {
...
(function (e) {
  ...
  function f(m) {
    ...
    return (
      l.isKanjiModeEnabled()
        ? ((g = u(o.BYTE, t.BYTE, m)), (v = u(o.KANJI, t.KANJI, m)))
        : ((g = u(o.BYTE_KANJI, t.BYTE, m)), (v = [])),
      E.concat(p, g, v)
        .sort(function (S, $) {
    ...
    for (let p = 0; p < m.length; p++) {
      ...
      switch (g.mode) {
        ...
        case t.ALPHANUMERIC:
          ...
          break;
        case t.KANJI:
          E.push([g, { data: g.data, mode: t.BYTE, length: c(g.data) }]);
          break;
        case t.BYTE:
          E.push([{ data: g.data, mode: t.BYTE, length: c(g.data) }]);
      }
    }
    return E;
  }
  function y(m, E) {
    ...
    for (let w = 0; w < m.length; w++) {
      ...
      for (let B = 0; B < S.length; B++) {
        const _ = S[B],
          M = "" + w + B;
        $.push(M), (p[M] = { node: _, lastCount: 0 }), (g[M] = {});
        for (let N = 0; N < v.length; N++) {
          const R = v[N];
          p[R] && p[R].node.mode === _.mode
            ? ((g[R][M] =
                h(p[R].lastCount + _.length, _.mode) -
                h(p[R].lastCount, _.mode)),
              (p[R].lastCount += _.length))
            : (p[R] && (p[R].lastCount = _.length),
              (g[R][M] =
                h(_.length, _.mode) + 4 + t.getCharCountIndicator(_.mode, E)));
        }
      }
      v = $;
    }
  ...
  function C(m, E) {
    ...
    if (((p = t.from(E, g)), p !== t.BYTE && p.bit < g.bit))
      throw new Error(
        '"' +
          m +
...
function Qi(e, t, n) {
  ...
  for (v = 0; v < h; v++) for (w = 0; w < o; w++) p[g++] = C[w][v];
  return p;
}
function Zi(e, t, n, i) {
  let r;
...
(function (e) {
  ...
  (e.render = function (s, o, l) {
    ...
    return (
      t.qrToImageData(h.data, s, a), n(f, c, u), f.putImageData(h, 0, 0), c
    );
  }),
